...
#Network Details
vnet_name = "KnowledgeAssist_dev_Vnet"
address_space = "10.0.1.0/24"
subnet_name = ["Pub-Subnet-App-Gateway", "WebApp-Subnet", "Database-Subnet", "AISearch-Subnet", "VM-Subnet" ]
subnet_range = ["10.0.1.0/27", "10.0.1.32/27", "10.0.1.64/27", "10.0.1.96/27", "10.0.1.128/27" ]

#Application Gateway Details:
agw_key_vault = "/subscriptions/7f770ce7-a2df-43ef-b60f-bd1aa82812d9/resourceGroups/KnowledgeAssist-dev/providers/Microsoft.KeyVault/vaults/gchakveuspmarsawg"
...
backend_pool_webapp_name = ["cka-backendapi-dev"]
...
#AI Search Services
AISearch_Service = ["searchserviceckadev", "standard2", "Dev"]
