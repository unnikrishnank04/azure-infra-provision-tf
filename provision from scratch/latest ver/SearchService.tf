...
/*
  ...
  restore {
    restore_source = "/subscriptions/7f770ce7-a2df-43ef-b60f-bd1aa82812d9/resourceGroups/KnowledgeAssist_dev1/providers/Microsoft.Search/searchServices/searchserviceckadev"
  }
*/
}
